...
const SkipCard = ({
  ...
  return (
      <div
          onClick={onSelect}
          className={`
        border rounded-2xl p-4 sm:p-6 cursor-pointer relative 
        transition-all duration-300 ease-in-out hover:-translate-y-1 
        hover:shadow-xl group
        h-96 sm:h-[28rem] overflow-y-auto
        ${
              selected
      ...
      >
        ...
        <div className="space-y-3">
          <h3 className="text-xl font-bold text-gray-800 sticky top-0 bg-white z-10 py-2">
            {size} Yard Skip
          </h3>
